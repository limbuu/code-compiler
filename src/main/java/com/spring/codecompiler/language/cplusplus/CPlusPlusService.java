package com.spring.codecompiler.language.cplusplus;
...
public class CPlusPlusService {
	...
	public 	Map<String, String> solveCplusplusChallenge(CodeChallenge codeChallenege, String sourceCode) throws IOException {
		
	Map<String, String> output = new HashMap<>();
	File rootDirectory = this.fileManager.createDirectory(FileServiceConstants.basic_file_Path);
	File file = this.fileManager.createFile(rootDirectory+FileServiceConstants.cplusplus_file_name);
