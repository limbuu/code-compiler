package com.spring.codecompiler.language.javascript;
...
public class JavaScriptService {
	...
	public 	Map<String, String> solveJavaScriptChallenge(CodeChallenge codeChallenege, String sourceCode) throws IOException {
		
		Map<String, String> output = new HashMap<>();
		File rootDirectory = this.fileManager.createDirectory(FileServiceConstants.basic_file_Path);
		File file = this.fileManager.createFile(rootDirectory+FileServiceConstants.javaScript_file_name);
