package com.spring.codecompiler.language.cprogram;
...
public class CprogramService {
	...
	public 	Map<String, String> solveCprogramChallenge(CodeChallenge codeChallenege, String sourceCode) throws IOException {
		
	Map<String, String> output = new HashMap<>();
	File rootDirectory = this.fileManager.createDirectory(FileServiceConstants.basic_file_Path);
	File file = this.fileManager.createFile(rootDirectory+FileServiceConstants.cprogram_file_name);
