package com.spring.codecompiler.language.shellscript;
...
public class ShellScriptService {
	...
	public Map<String, String> solveShellscriptChallenge(CodeChallenge codeChallenege,String sourceCode) throws IOException {
		...
		String[] runCommand = {"test.sh",file.getAbsolutePath()};
